...
import 'pdf_export_diagnostic.dart';
...
class VoucherExportService {
        ...
        pw.Page(
          ...
          build: (pw.Context context) {
            return pw.Column(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                // Header - standardized for Own Sales
                _buildStandardizedInvoiceHeader(
                  sales,
                  profile,
                  logoBytes,
                  padaukRegular,
  ...
  // DEPRECATED: Old _buildInvoiceHeader method removed in Phase 2
  // Now using _buildStandardizedInvoiceHeader for both PNG and PDF exports
  ...
  pw.Widget _buildStandardizedInvoiceHeader(
    ...
    final moneyFormat = NumberFormat('#,##0', 'en_US');
    final dateFormat = DateFormat('dd/MM/yyyy', 'my');

    // Own sales always use fixed voucher type
    // (Broker sales use separate BrokerVoucherDocumentData system)
    final voucherType = 'ကိုယ်တိုင်ရောင်းချမှု';
    ...
    final dateStr = dateFormat.format(DateTime.fromMillisecondsSinceEpoch(saleDate));
    ...
    return pw.Column(
      ...
      children: [
        ...
        row3,
        pw.SizedBox(height: 8),
        if (row4 is! pw.SizedBox) ...[row4, pw.SizedBox(height: 8)],
        row5,
      ],
    );
  }
// Trigger build Wed Aug 12 09:31:19 UTC 2026
// Build trigger Wed Aug 12 09:39:03 UTC 2026
// Build trigger Wed Aug 12 09:45:13 UTC 2026
// Build trigger Wed Aug 12 10:19:23 UTC 2026
...
// Build trigger Wed Aug 12 10:59:36 UTC 2026
// Build trigger Wed Aug 12 11:07:05 UTC 2026
// Build trigger Thu Aug 13 10:45:16 UTC 2026
